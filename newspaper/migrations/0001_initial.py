    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dating_comment', models.DateTimeField(default=datetime.datetime.now, verbose_name='Dating Comment', blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video', models.FileField(upload_to=b'documents/video/news/%Y/%m/%d', null=True, verbose_name='Video', blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-first_name'],
                'db_table': 'auth_user',
                'verbose_name': 'User Authenticated',
                'verbose_name_plural': 'Users Authenticated',
                'permissions': (('access_manager', 'Access Manager'),),
            },
        ...
        migrations.CreateModel(
            name='Redator',
            fields=[
                ('userauthenticated_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Redator',
                'verbose_name_plural': 'Redators',
                'permissions': (('keep_journalist', 'Keep Journalist'), ('keep_classifield', 'Keep Classifield'), ('keep_section', 'Keep Section'), ('keep_subsection', 'Keep SubSection'), ('delete_news', 'Delete News')),
            },
            bases=('newspaper.userauthenticated',),
        ),
        migrations.CreateModel(
            name='Lector',
            fields=[
            ...
            options={
                ...
                'permissions': (('registering_lector', 'Registering Lector'), ('comment_news', 'Comment News'), ('offer_to_buy', 'Offer to Buy')),
            },
            bases=('newspaper.userauthenticated',),
        ),
        migrations.CreateModel(
